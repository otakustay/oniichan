...
export function renderRingRingActorObjective() {
    return dedent`
        # Objective
...
export function renderUniversalActorObjective() {
    return dedent`
        # Objective
...
export function renderObjectiveSection(view: InboxPromptView) {
    switch (view.role) {
        ...
        case 'actor':
            return view.mode === 'ringRing' ? renderRingRingActorObjective() : renderUniversalActorObjective();
        case 'coder':
        case 'standalone':
