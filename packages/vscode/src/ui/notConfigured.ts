import {commands, InputBoxOptions, QuickPickItem, window} from 'vscode';
import {getModelConfiguration, updateModelConfiguration} from '../utils/config';
import {ModelApiStyle} from '@oniichan/shared/model';
